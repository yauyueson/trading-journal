...
export function computeAnalytics(
  ...
  return {
    ...
    tradeSharpeLegacy: isFinite(sharpe) ? sharpe : 0,
    dailyPortfolioSharpe: undefined,
    realizedExitDrawdownPct: maxDrawdown * 100,
    dailyMtMDrawdownPct: undefined,
    metricBasis: 'trade_hold_legacy',
