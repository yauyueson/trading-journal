...
import { LayoutDashboard, List, History, BarChart3, Search } from 'lucide-react';
        ...
        >
            {tabs.map(tab => (
                <button
                    ...
                    className={`flex-1 sm:flex-none flex flex-col sm:flex-row items-center justify-center gap-1.5 sm:gap-2 sm:px-5 py-3 sm:py-4 min-h-[60px] sm:min-h-auto transition-colors relative cursor-pointer
