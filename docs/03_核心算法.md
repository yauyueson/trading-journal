...
**版本**: 2.2 (Non-Linear Penalty Curves)

**v2.2 新增**:
- Theta Pain Curve: 指数型惩罚曲线，对末日轮毁灭性打击
- IV Sigmoid: 相变模型，平滑的恐慌/冷静切换
...
```
|Δ| < 0.15  → -2.0  (彩票惩罚)
|Δ| 0.15-0.30 → -0.5  (激进区轻微惩罚)
|Δ| 0.30-0.50 → +1.0  (甜蜜区奖励)
|Δ| 0.50-0.70 → +0.5  (稳定区奖励)
|Δ| > 0.70  → 0     (深度ITM中性)
```

**解释**:
- 0.30-0.50 Delta是最佳平衡点
- 避免OTM彩票（Delta<0.15）
- 深度ITM杠杆不足
