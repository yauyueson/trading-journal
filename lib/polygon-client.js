...
function normalizePolygonOption(polygonData) {
    ...
    return {
        ...
        dte: dte,
        bid: Number(lastQuote.bid || polygonData.day?.vwap || polygonData.day?.close || polygonData.day?.previous_close || 0),
        ask: Number(lastQuote.ask || polygonData.day?.vwap || polygonData.day?.close || polygonData.day?.previous_close || 0),
        last: Number(polygonData.last_trade?.price || polygonData.day?.close || polygonData.day?.previous_close || 0),
