...
const DEFAULT_OPTIONS = {
    w_mb: 30, w_bxs: 30, w_bxl: 15, w_ema: 15, w_mom: 10,
 ...
 * @param {number} [options.sc_mb_len] Market Bias period (default 20)
 * @param {number} [options.sc_mb_smoothing] HA smoothing period (default 7)
 ...
 * @param {number} [options.sc_bx_s3] B-X Short L3 (default 5)
 * @param {number} [options.sc_bx_l1] B-X Long L1 (default 20)
 * @param {number} [options.sc_bx_l2] B-X Long L2 (default 5)
