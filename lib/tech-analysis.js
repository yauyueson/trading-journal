...
const DEFAULT_OPTIONS = {
    ...
    sc_mb_len: 100, sc_bx_s1: 5, sc_bx_s2: 20, sc_bx_s3: 15, sc_bx_l1: 20, sc_bx_l2: 15
};
 ...
 * @param {number} [options.sc_mb_len] Market Bias period (default 100)
 * @param {number} [options.sc_bx_s1] B-X Short EMA1 (default 5)
 * @param {number} [options.sc_bx_s2] B-X Short EMA2 (default 20)
 * @param {number} [options.sc_bx_s3] B-X Short RSI period (default 15)
 * @param {number} [options.sc_bx_l1] B-X Long EMA (default 20)
 * @param {number} [options.sc_bx_l2] B-X Long RSI period (default 15)
