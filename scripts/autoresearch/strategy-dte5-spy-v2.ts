/**
 * DTE5 SPY v2 — Phase E8 (direction bug fixed).
 *
 * Phase E5 (PR #11) had direction='PUT' (bear call). This v2 uses
 * direction='CALL' (bull put) + simplified canonical DTE5 signal.
 *
 * Run via:
 *   AUTORESEARCH_LEADERBOARD_SUFFIX=dte5-spy-v2 \
 *   AUTORESEARCH_STRATEGY_FILENAME=strategy-dte5-spy-v2.ts \
...
const DTE5_SPY_V2_ANCHOR: SimConfig = {
  mode: 'CREDIT_SPREAD',
...
const configVariants: ConfigVariant[] = [
  { name: 'dte5-spy-v2-tight', overrides: { creditShortDelta: 0.25 } },
  { name: 'dte5-spy-v2-wide',  overrides: { creditShortDelta: 0.35 } },
  { name: 'dte5-spy-v2-w10',   overrides: { creditSpreadWidth: 10 } },
];

export const strategy: StrategyDefinition = {
  name: 'dte5-spy-v2-anchor',
  tickers: ['SPY'],
